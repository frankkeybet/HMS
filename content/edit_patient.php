<?php
    ...
    $sql = "UPDATE tbl_patient SET ward_id='$ward_id', bed_id='$bed_id', patient_name='$patient_name', patient_address='$patient_address', patient_phone='$patient_phone', patient_nid='$patient_nid', admission_date='$admission_date', release_date='$release_date' WHERE patient_id='$patient_id' ";
?>
<div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="admission_date" value="<?php echo $all_patient['admission_date']?>" class="form-control">
                                    </div>        
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Release Date</label>
                                        <input type="date" name="release_date" value="<?php echo $all_patient['release_date']?>" class="form-control">
                                    </div>        
                                </div>
                            </div>
